    ...
    <>
      <Box className={classes.mainContainer}>
        <ServicesGrid
          ...
          text2="Services"
          image="assets/images/transNew.jpg"
        />
      </Box>
        ...
        <Grid container className={classes.containerNeew1}>
          <Card className={classes.cardFirst}>
            <Typography variant="h6" className={classes.paraPadidng}>
              <ul>
                <li>
                  Translation and interpretation services offered by GSD
                  associates are essential for breaking language barriers,
                  enabling effective communication in a globalized world, and
                  facilitating business expansion, international collaboration,
                  and access to information in different languages.
                </li>
                <li>
                  Document Translation: Converting written documents such as
                  reports, contracts, and manuals from one language to another
                  accurately and coherently.
                </li>
                <li>
                  Oral Interpretation: Providing interpreters to facilitate
                  real-time communication in meetings, conferences, phone calls,
                  and live events.
                </li>
                <li>
                  SOP Creation : Assist with creating SOP manuals for client
                  internal use. (If not already done)
                </li>
              </ul>
            </Typography>
          </Card>
