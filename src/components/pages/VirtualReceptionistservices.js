    ...
    <>
      <Box className={classes.mainContainer}>
        <ServicesGrid
          ...
          text2="Services"
          image="assets/images/virtualNew.jpg"
        />
      </Box>
        ...
        <Grid container className={classes.containerNeew1}>
          <Card className={classes.cardFirst}>
            <Typography variant="h6" className={classes.paraPadidng}>
              <ul>
                <li>
                  Elevate your business presence with our state-of-the-art
                  virtual receptionist solutions. Our automated service are
                  designed to greet your callers with a personalized touch,
                  directing them efficiently to the right department or person.
                </li>
                <li>
                  Enjoy the benefits of a virtual assistant ensuring no call
                  goes unanswered.
                </li>
                <li>
                  Experience the convenience of appointment scheduling, call
                  forwarding, and message management, all tailored to suit your
                  business needs.
                </li>
                <li>
                  Embrace efficiency, enhance customer experience, and make
                  every call count with our Virtual Receptionist services.
                </li>
              </ul>
            </Typography>
          </Card>
