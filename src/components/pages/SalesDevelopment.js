    ...
    <>
      <Box className={classes.mainContainer}>
        <ServicesGrid
          text1="Sales And"
          text2="Development"
          image="assets/images/salesNew.jpg"
        />
      </Box>
        ...
        <Grid container className={classes.containerNeew1}>
          <Card className={classes.cardFirst}>
            <Typography variant="h6" className={classes.paraPadidng}>
              Introducing our Sales Virtual Assistants – your strategic ally in
              the world of sales excellence! From meticulous prospect data
              building to expert lead management with a focus on sales
              enablement, our virtual assistants empower your team to achieve
              peak performance. Elevate your sales strategy, optimize lead
              workflows, and embrace a new era of efficiency with our Sales
              Virtual Assistants. Transforming prospects into loyal customers
